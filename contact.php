...
<body id="top">
  ...
  <header class="header">
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:donorhero@gmail.com" class="contact-link">donorhero@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+627558951351" class="contact-link">+62-7558-951-351</a>
          </li>
        </ul>
        <ul class="social-list">
          <li>
            <a href="https://www.facebook.com/Daew.12" class="social-link">
              <ion-icon name="logo-facebook"></ion-icon>
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/daew.12" class="social-link">
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        <a href="#" class="logo">Donor Hero</a>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="section-subtitle">Donor Hero</p>
            <h1 class="h1 hero-title">Contact Us</h1>
            <h2 style="color: var(--royal-blue-light);">Address</h2>
            <p class="hero-text">
            Jl. Margonda No.545, RT.1/RW.7, Pondok Cina, <br />
            Kecamatan Beji, Kota Depok, Jawa Barat 16424,ID
            </p>
            <h2 style="color: var(--royal-blue-light);">Contact Details</h2>
            <p class="hero-text">
            MOBILE: +62 7558 9513 51 | TELEPHONE: 6969-696969<br>
            EMAIL : donorhero@gmail.com<br>
            </p>
          ...
          <figure class="hero-banner">
            <iframe src="https://maps.app.goo.gl/kucDy2SQaHqqGa919" width="700" height="600" style="border:1;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </figure>
        </div>
    </section>
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="https://maps.app.goo.gl/kucDy2SQaHqqGa919">
            <address class="item-text">
            Jl. Margonda No.545, RT.1/RW.7, Pondok Cina, Kecamatan Beji,
            <br />
                  Kota Depok, Jawa Barat 16424,ID
            </address>
          </a>
          </li>
          <li class="footer-item">
            ...
            <a href="tel:+627052101786" class="footer-link">+62-7558-951-351</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:help@example.com" class="footer-link">donorhero@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; 2024 All Rights Reserved by Donor Hero
        </p>
        <ul class="social-list">
          <li>
